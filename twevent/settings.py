# Django settings for twevent project.
import os.path
...
DATABASES = {
    'default': {
        ...
        'NAME': 'twevent',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 's5hn+ap&=ojn4tgbw4pdl4-0ethzwjaopwk^j_8umqv2hk(kj#'
